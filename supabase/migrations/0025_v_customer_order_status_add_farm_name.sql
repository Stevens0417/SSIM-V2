-- =========================================================
-- 0025_v_customer_order_status_add_farm_name.sql
--
-- Rebuild v_delivery_customer_order_status to include
-- farm_name from the customers table.
--
-- This allows the agent fulfillment tool to match orders by
-- farm/business name in addition to individual customer name.
--
