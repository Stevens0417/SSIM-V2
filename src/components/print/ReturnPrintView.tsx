import styles from "./ReturnPrintView.module.css";

export interface ReturnPrintItem {
  product: string;
  treatment: string;
  units: number;
}

export interface ReturnPrintCustomer {
  name: string;
  farmName: string;
  tsaNumber: string;
  phone: string;
...
export default function ReturnPrintView({
  returnDate,
  customer,
  items,
  notes,
    ...
    <div className={styles.page}>
      ...
      <div className={styles.header}>
        ...
        <div className={styles.headerText}>
          <div className={styles.headerLine1}>Seed Return Form</div>
        ...
        <div className={styles.sectionBody}>
          <div className={styles.infoGrid}>
            ...
            <div className={styles.infoRow}>
              ...
              <span className={styles.infoValue}>{returnDate}</span>
            </div>
            <div className={styles.infoRow}>
      ...
      <div className={`${styles.section} ${styles.sectionItems}`}>
        <div className={styles.sectionTitle}>Return Items</div>
        <table className={styles.itemsTable}>
          <thead>
            <tr>
              <th className={styles.colProduct}>Product</th>
              <th className={styles.colTreatment}>Treatment</th>
              <th className={styles.colUnits}>Units Returned</th>
            </tr>
          </thead>
          <tbody>
            {items.map((it, i) => (
