import styles from "./ReplantPrintView.module.css";

export interface ReplantPrintItem {
  product: string;
  treatment: string;
  units: number;
}

export interface ReplantPrintCustomer {
  name: string;
  farmName: string;
  tsaNumber: string;
  phone: string;
...
export default function ReplantPrintView({
  replantDate,
  customer,
  items,
  notes,
    ...
    <div className={styles.page}>
      ...
      <div className={styles.header}>
        ...
        <div className={styles.headerText}>
          <div className={styles.headerLine1}>Seed Replant Form</div>
      ...
      <div className={`${styles.section} ${styles.sectionCustomer}`}>
        ...
        <div className={styles.sectionBody}>
          <div className={styles.infoGrid}>
            ...
            <div className={styles.infoRow}>
              <span className={styles.infoLabel}>Replant Date:</span>
              <span className={styles.infoValue}>{replantDate}</span>
            </div>
            <div className={styles.infoRow}>
      ...
      <div className={`${styles.section} ${styles.sectionItems}`}>
        <div className={styles.sectionTitle}>Replant Items</div>
        <table className={styles.itemsTable}>
          <thead>
            <tr>
              <th className={styles.colProduct}>Product</th>
              <th className={styles.colTreatment}>Treatment</th>
              <th className={styles.colUnits}>Units Replanted</th>
            </tr>
          </thead>
          <tbody>
            {items.map((it, i) => (
